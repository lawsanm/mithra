 ...
 * stand-in for the Router + middleware chain + controllers, which is
 * frozen-core work owned by whoever builds it.
 *
 * Runs behind Apache (public/.htaccess sends every unmatched request here) and
 * behind PHP's built-in server (public/router.php requires this file).
 *
 * REPLACE THIS FILE, and delete preview.php and preview-data.php, once real
 * controllers dispatch routes.
 */

// The URL prefix the app is served under — '' at a domain root, '/mithra' when
// Apache serves it from htdocs/mithra. router.php defines it as '' up front.
if (!defined('APP_BASE')) {
...
// Requests arrive as /mithra/items; the route table below speaks /items.
...
function router_notice(string $title, string $detail, string $hint): void
{
    ...
    echo '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8">'
       ...
       . '<link rel="stylesheet" href="' . $e(base_url()) . '/css/main.css"></head><body><main class="page">'
